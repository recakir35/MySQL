...
-- ========================================================================================*/
 ...
 CREATE TABLE calisanlar(id CHAR(5) PRIMARY KEY, -- not null + unique
isim VARCHAR(50) UNIQUE, maas int NOT NULL, ise_baslama DATE );
...
INSERT INTO calisanlar VALUES('10007', 'CAN', 5000, '2018-04-14'); 		-- Unik kısıtlaması
...
INSERT INTO calisanlar VALUES( '10002', 'ayse Yılmaz' ,12000, '2018-04-14'); 	-- Unik
INSERT INTO calisanlar VALUES( null, 'filiz ' ,12000, '2018-04-14');			-- null
...
CREATE TABLE adresler (adres_id CHAR(5), sokak VARCHAR(50), cadde VARCHAR(30), sehir VARCHAR(15),
...
CREATE TABLE talebeler(id CHAR(3) primary key, isim VARCHAR(50),veli_isim VARCHAR(50), yazili_notu int );
...
CREATE TABLE notlar ( talebe_id char(3), ders_adi varchar(30), yazili_notu int,
