...
*/
update insanlar set isim=coalesce(isim, 'Henuz isim girilmedi'),adres=coalesce(adres, 'Henuz adres girilmedi'),ssn=coalesce(ssn,'no ssn') where isim is null or adres is null or ssn is null ;
select * from insanlar;